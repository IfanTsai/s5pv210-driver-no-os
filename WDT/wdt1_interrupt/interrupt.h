...
#define    EXCEPTION_RESET		    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x00)))
#define    EXCEPTION_UNDEF		    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x04)))
#define    EXCEPTION_SWI	        (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x08)))
#define    EXCEPTION_PREFETCH	    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x0C)))
#define    EXCEPTION_DATA		    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x10)))
#define    EXCEPTION_IRQ		    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x18)))
#define    EXCEPTION_FIQ		    (*((volatile unsigned int *)(EXCEPTION_VECTOR_BASE + 0x1C)))
